...
<body style="background-color:#ecf0f1;">
    <div class="wrapper">
          ...
          <div class="row">
            <form action="<?php echo base_url(); ?>kendalicrud/searchdata_kendali" method="post" id="form_searchbar">
            ...
            <form action="<?php echo base_url(); ?>kendalicrud/range_tanggal_kendali" method="post" id="form_range_tanggal">
                <div class="col-md-2">
			...
			<div class="row">
			   <form action="<?php echo base_url();?>kendalicrud/filter_kendali" method="post">
