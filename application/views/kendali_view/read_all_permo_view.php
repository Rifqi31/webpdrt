...
<body style="background-color:#ecf0f1;">
    <div class="wrapper">
		...
		<div class="row">
            <form action="<?php echo base_url(); ?>kendalicrud/searchdata_permo" method="post" id="form_searchbar3">
                <div class="col-md-6" style="padding-left:30px;">
                    <input type="text" class="form-control form-inline" name="allpermo" placeholder="Search Anything...">
                </div>
                <div class="col-md-1">
                    <button class="btn btn-default btn-round"><i class="fa fa-search"></i></button>
                </div>
            </form>
            <form action="<?php echo base_url(); ?>kendalicrud/range_tanggal_permo" method="post" id="form_range_tanggal">
                <div class="col-md-2">
		 ...
		 <div class="row">
		   <form action="<?php echo base_url();?>kendalicrud/filter_permo" method="post">
