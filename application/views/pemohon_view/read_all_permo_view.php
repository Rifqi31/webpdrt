...
<body style="background-color:#ecf0f1;">
    <div class="wrapper">
		...
		<div class="row">
            <form action="<?php echo base_url(); ?>pdrtcrud/searchdata_permo" method="post" id="form_searchbar">
            ...
            <form action="<?php echo base_url(); ?>/pdrtcrud/range_tanggal_permo" method="post" id="form_range_tanggal">
                <div class="col-md-2">
		 ...
		 <div class="row">
		   <form action="<?php echo base_url();?>pdrtcrud/filter_permo" method="post">
