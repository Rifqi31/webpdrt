<div class="row">
   <form action="<?php echo base_url();?>pdrtcrud/export_filter" method="post">
     ...
     <form action="<?php echo base_url(); ?>/pdrtcrud/export_range" method="post" id="form_range_tanggal2">
                <div class="col-md-2">
                    <input type="text" class="form-control form-inline" name="tgl_awal" id="datetimepicker14" placeholder="tanggal awal">
                </div>
                <div class="col-md-2">
                    <input type="text" class="form-control form-inline" name="tgl_akhir" id="datetimepicker15" placeholder="tanggal akhir">
                </div>
                <div class="col-md-1">
                    <button class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export</button>
                </div>
