...
<body style="background-color:#ecf0f1;">
    <div class="wrapper">
           ...
           <div class="container-fluid">
				   ...
				   <div class="collapse navbar-collapse menu-text" id="bs-example-navbar-collapse-1">
      				<ul class="nav navbar-nav">
        					...
        					<li class="active"><a href="<?php echo base_url('dataread/read_data_kendali');?>" style="color:black;">Kendali</a></li>
      				</ul>
		...
		<div class="row">
            <form action="<?php echo base_url(); ?>dataread/search_kendali" method="post" id="form_searchbar4">
            ...
            <form action="<?php echo base_url(); ?>dataread/range_tanggal_kendali" method="post" id="form_range_tanggal">
                <div class="col-md-2">
		 ...
		 <div class="row">
		   <form action="<?php echo base_url();?>dataread/filter_kendali" method="post">
